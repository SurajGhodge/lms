...
public class LeaveController1 {
	 ...
	 // Handle Apply Leave form submission
	    ...
	    public String applyLeave(@ModelAttribute("leaveRequest") LeaveRequestDto request,
	                             Model model,
	                             Principal principal) {
	        try {
	 ...
	 // Delete leave
	    ...
	    public String updateLeave(@PathVariable("id") Long id,
	                              @ModelAttribute("leave") Leaves leave) {
